...
def dqn_build_train(q_func, ob_space, ac_space, optimizer, sess, grad_norm_clipping=None,
    ...
    with tf.variable_scope(scope, reuse=reuse):
        if param_noise:
            ...
            act_f, obs_phs = dqn_build_act(q_func, ob_space, ac_space, stochastic_ph, update_eps_ph, sess)
